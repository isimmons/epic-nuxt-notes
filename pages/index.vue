<template>
  <div class="container text-center mt-36">
    ...
    <h2 class="my-2 font-bold">Humble Beginnings...</h2>
    <p class="text-xl">
      Started with create-remix and built up to match the Epicweb Workshop app.
    </p>
    <p class="text-xl">Then rebuilt with Nuxt</p>
